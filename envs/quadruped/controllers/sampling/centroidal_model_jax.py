...
if __name__=="__main__":
    ...
    state = jnp.array([0.0, 0.0, 0.0, # com position
                        0.0, 0.0, 0.0,   # com velocity
                        0.0, 0.0, 0.0,   # euler angles
                        0.0, 0.0, 0.0], dtype=dtype_general)  # euler rates
    
    input = jnp.array([0.0, 0.0, 0.0, # foot position fl
                           0.0, 0.0, 0.0, # foot position fr
                           0.0, 0.0, 0.0, # foot position rl
                           0.0, 0.0, 0.0, # foot position rr
                           0.0, 0.0, 0.0, # foot force fl
                           0.0, 0.0, 0.0, # foot force fr
                           0.0, 0.0, 0.0, # foot force rl
                           0.0, 0.0, 0.0], dtype=dtype_general) # foot force rr
    ...
    input_vec = random.randint(key,(model_jax.input_dim*threads,), minval=-2, maxval=2).reshape(threads,model_jax.input_dim)
