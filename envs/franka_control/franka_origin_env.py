...
class FrankaTeleoperationEnv(RobomimicEnv):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.EE_NAME  = self.site("gripper0_grip_site")
        self.OBJ_NAME = "cube_default_site"
        self.OBJ_JOINT_NAME = "cube_joint0"
        ...
        self._arm_joint_names = [self.joint("robot0_joint1"),
                                 self.joint("robot0_joint2"), 
                                 self.joint("robot0_joint3"), 
                                 self.joint("robot0_joint4"), 
                                 self.joint("robot0_joint5"), 
                                 self.joint("robot0_joint6"), 
                                 self.joint("robot0_joint7")]
        self._gripper_joint_names = [self.joint("gripper0_finger_joint1"), 
                                     self.joint("gripper0_finger_joint2")]
    ...
    def _get_obs(self) -> dict:
        ...
        obs = {
            ...
            "robot0_joint_pos": joint_values,
            "robot0_joint_pos_sin": joint_values_sin,
            "robot0_joint_pos_cos": joint_values_cos,
    ...
    def get_gripper_qpos(self) -> np.ndarray:
        qpos_dict = self.query_joint_qpos([self.joint("gripper0_finger_joint1"), self.joint("gripper0_finger_joint2")])
        finger1 = qpos_dict[self.joint("gripper0_finger_joint1")]
        finger2 = qpos_dict[self.joint("gripper0_finger_joint2")]
        return np.concatenate([finger1, finger2])
    
    def get_gripper_qvel(self) -> np.ndarray:
        qvel_dict = self.query_joint_qvel([self.joint("gripper0_finger_joint1"), self.joint("gripper0_finger_joint2")])
        finger1 = qvel_dict[self.joint("gripper0_finger_joint1")]
        finger2 = qvel_dict[self.joint("gripper0_finger_joint2")]
        return np.concatenate([finger1, finger2])
