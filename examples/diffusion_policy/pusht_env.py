...
if __name__ == "__main__":
    ...
    try:
        step_count = 0
        while step_count < 1000:  # Run for 100 steps
            ...
            # For human visualization (opens a window)
            env.render(mode='human')
            
            # For getting the image array
            img = env.render(mode='rgb_array')
            print(f"Step {step_count}: Rendered image shape: {img.shape}")
