...
if __name__ == "__main__":
    ...
    parser.add_argument('--action_type', type=str, help='The action type of the environment (end_effector_ik / end_effector_osc / joint_pos / joint_motor)')
    ...
    parser.add_argument('--augmented_noise', type=float, default=0.005, help='The noise to augment the dataset')
    ...
    parser.add_argument('--level', type=str, help='The storage level or scenario for file storage (e.g., default, experiment, debug)')
