...
4. [Architecture Overview](architecture-overview.md) — Understand the overall layered design, API boundaries, and call flow
5. [System Architecture](architecture.md) — Understand component design, API contracts, encapsulation isolation, and migration guide
