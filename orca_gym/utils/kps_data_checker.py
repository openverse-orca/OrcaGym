...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_files", type=str, nargs='+', default=["Shop-Cashier_Operation.json", "Shop-Shelf_Operation.json", "Kitchen-Countertop_Operation.json", "Pharmacy-Shelf_Operation.json","fridge-Fridge_Operation.json","pharmacy-Cooler_Operation.json","3c_scan_3cscan_Operation","guizi_Cooler"], help='The json files to check')
